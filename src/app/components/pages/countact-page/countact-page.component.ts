...
@Component({
  selector: 'app-countact-page',
  templateUrl: './countact-page.component.html',
  styleUrls: ['./countact-page.component.scss']
})
export class CountactPageComponent implements OnInit {
